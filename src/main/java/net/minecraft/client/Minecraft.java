...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    /**
     * A 10MiB pre allocation to ensure the heap is reasonably sized.
     */
    ...
    public FontRenderer fontRendererObjWithoutUnicode;
    ...
    public FontRenderer backupFont;
    ...
    private void startGame() throws LWJGLException {
        ...
        this.fontRendererObjWithoutUnicode = new FontRenderer(this.gameSettings, new ResourceLocation("textures/font/ascii.png"), this.renderEngine, false);

        if (this.gameSettings.language != null) {
            this.fontRendererObj.setUnicodeFlag(this.isUnicode());
            this.fontRendererObjWithoutUnicode.setUnicodeFlag(false);
            this.fontRendererObj.setBidiFlag(this.mcLanguageManager.isCurrentLanguageBidirectional());
            this.fontRendererObjWithoutUnicode.setBidiFlag(this.mcLanguageManager.isCurrentLanguageBidirectional());

        }
        this.backupFont = this.fontRendererObjWithoutUnicode;

        this.standardGalacticFontRenderer = new FontRenderer(this.gameSettings, new ResourceLocation("textures/font/ascii_sga.png"), this.renderEngine, false);
        this.mcResourceManager.registerReloadListener(this.fontRendererObj);
        this.mcResourceManager.registerReloadListener(this.fontRendererObjWithoutUnicode);
        ...
        FPSMaster.INSTANCE.initClient();
        this.drawSplashScreen(3);
        EventManager.call(new EventValue(ClientSettings.mcFont));
        ...
        if (this.serverName != null) {
            this.displayGuiScreen(new GuiStartup(new GuiConnecting(new GuiMainMenu(), this, this.serverName, this.serverPort)));
        } else {
            this.displayGuiScreen(new GuiStartup(new GuiMainMenu()));
        }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(FPSMaster.CLIENT_NAME + " " + FPSMaster.VERSION + FPSMaster.INSTANCE.description);
    ...
    private void drawSplashScreen(int stage) {
        ...
        Gui.drawRect(0, 0, sr.getScaledWidth(), sr.getScaledHeight(), new Color(245, 245, 245).getRGB());
        int startX = (sr.getScaledWidth() - 6 * 10) / 2;
        for (int i1 = 0; i1 < 6; i1++) {
            RenderUtil.circle(startX + 5, sr.getScaledHeight() - 90, 2, stage > i1 ? new Color(94, 142, 255).getRGB() : new Color(56, 56, 56).getRGB());
            startX += 10;
        }
        RenderUtil.drawCustomImage(sr.getScaledWidth() / 2f - 50, 60, 100, 37, new ResourceLocation("client/logoF.png"));
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
    ...
    public void shutdownMinecraftApplet() {
        try {
            FPSMaster.INSTANCE.configManager.saveConfig("current");
    ...
    private void runGameLoop() throws IOException {
        ...
        AntiCheat.active = !this.isSingleplayer() && this.currentServerData != null && this.currentServerData.serverIP != null;
    ...
    private void clickMouse() {
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                LogManager.getLogger().error("Null returned as 'hitResult', entity shouldn't happen!");
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    case ENTITY:
                        FPSMaster.INSTANCE.checkManager.execute(CheckManager.LEFT_CLICK, MovingObjectPosition.MovingObjectType.ENTITY, this.objectMouseOver.entityHit, this.objectMouseOver.hitVec, this.thePlayer.getPositionEyes(1.0F).distanceTo(this.objectMouseOver.hitVec));
    ...
    public void runTick() throws IOException {
        ...
        FPSMaster.INSTANCE.checkManager.init();
        AntiCheat.active = !this.isSingleplayer() && this.currentServerData != null && this.currentServerData.serverIP != null;
        if (this.thePlayer != null) {
            EventManager.call(new EventTick());
            FPSMaster.INSTANCE.checkManager.execute(CheckManager.TICK);
            if (this.thePlayer.lastAttackTick < 0) {
                this.thePlayer.attackedOther = false;
            }
        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                EventManager.call(new EventKeyInput());
            }
            ...
            if (this.thePlayer.isUsingItem()) {
                ...
                while (this.gameSettings.keyBindAttack.isPressed()) {
                    Utils.cpsUtil.update(0);
                    FPSMaster.INSTANCE.checkManager.execute(CheckManager.LEFT_CLICK);
                    EventManager.call(new EventMouseInput(0));
                }
            } else {
                while (this.gameSettings.keyBindAttack.isPressed()) {
                    Utils.cpsUtil.update(0);
                    ...
                    if (this.objectMouseOver != null) {
                        switch (this.objectMouseOver.typeOfHit) {
                            ...
                            case BLOCK:
                                BlockPos blockpos = this.objectMouseOver.getBlockPos();
                                if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air) {
                                    FPSMaster.INSTANCE.checkManager.execute(CheckManager.LEFT_CLICK, this.objectMouseOver.typeOfHit, blockpos, this.objectMouseOver.sideHit);
                                    break;
                                }
                                FPSMaster.INSTANCE.checkManager.execute(CheckManager.LEFT_CLICK, MovingObjectPosition.MovingObjectType.MISS);
                                break;
                            case MISS:
                            default:
                                FPSMaster.INSTANCE.checkManager.execute(CheckManager.LEFT_CLICK, this.objectMouseOver.typeOfHit);
                                break;
                        }
                        this.clickMouse();
                    } else {
                ...
                while (this.gameSettings.keyBindUseItem.isPressed()) {
                    ...
                    Utils.cpsUtil.update(1);
                    EventManager.call(new EventMouseInput(1));
                }
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn) {
        this.loadWorld(null);
        if (!(MemoryManager.fastLoad.getValue() && FPSMaster.INSTANCE.moduleManager.modules.get("MemoryManager").stage)) {
            System.gc();
        }
