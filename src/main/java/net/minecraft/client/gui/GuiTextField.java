...
public class GuiTextField extends Gui {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                String lvt_10_1_ = flag ? s.substring(0, j) : s;
                j1 = this.fontRendererInstance.drawStringWithShadow(lvt_10_1_, (float)l, (float)i1, i);
            }

//            String s1;
//            if (s.length() > 0) {
//                s1 = flag ? s.substring(0, j) : s;
//                j1 = this.fontRendererInstance.getStringWidth(s1);
//                this.fontRendererInstance.drawString(s1, l, i1, i);
//            }
...
//                k1 = j > 0 ? l + this.width : l;
            ...
            if (flag2) {
                this.fontRendererInstance.drawStringWithShadow(s.substring(k),k1 + (this.enableBackgroundDrawing ? 10 : 0) + 1, (float) i1, i);
            }
            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1 + (this.enableBackgroundDrawing ? 10 : 0), i1 - 1, k1 + 1 + (this.enableBackgroundDrawing ? 10 : 0), i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
                } else {
                    this.fontRendererInstance.drawStringWithShadow("_",( this.enableBackgroundDrawing ? 10 : 0 )+ (float) xPosition + fontRendererInstance.getStringWidth(s), (float) i1, i);
                }
            }
