...
import top.fpsmaster.modules.render.Crosshair;
...
public class GuiIngame extends Gui {
    ...
    public boolean displayingCheating;
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        assert FPSMaster.INSTANCE.guiCustom != null;
        FPSMaster.INSTANCE.guiCustom.drawGuis();
        ...
        if (this.showCrosshair()) {
            ...
            if (FPSMaster.INSTANCE.moduleManager.modules.get("Crosshair").stage) {
                Crosshair.render();
            } else {
        ...
        if (this.titlesTimer > 0) {
            ...
            if (i2 > 8) {
                ...
                GlStateManager.pushMatrix();
                FPSMaster.INSTANCE.fontLoader.client72.drawStringWithShadow(this.displayedTitle, (float) (-FPSMaster.INSTANCE.fontLoader.client72.getStringWidth(this.displayedTitle) / 2), -15.0F, 16777215 | j2);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                FPSMaster.INSTANCE.fontLoader.client36.drawStringWithShadow(this.displayedSubTitle, (float) (-FPSMaster.INSTANCE.fontLoader.client36.getStringWidth(this.displayedSubTitle) / 2), 8.0F, 16777215 | j2);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
