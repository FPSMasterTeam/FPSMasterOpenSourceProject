...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(66, 4, 5, 100, 20, I18NUtils.getString("settings.tcpNoDelay") + ": " + TCPNoDelay.isActive()));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            if (button.id == 66) {
                TCPNoDelay.toggle();
                button.displayString = I18NUtils.getString("settings.tcpNoDelay") + ": " + TCPNoDelay.isActive();
            }
