...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FPSMaster.INSTANCE.fontLoader.client18.drawStringWithShadow(FPSMaster.CLIENT_NAME + " " + FPSMaster.VERSION,5,sr.getScaledHeight()-12,new Color(255,255,255,200).getRGB());
        int i = this.guiLeft;
        int j = this.guiTop;
