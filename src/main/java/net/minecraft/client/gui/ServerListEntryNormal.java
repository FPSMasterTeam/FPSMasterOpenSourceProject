...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        if (this.mc.gameSettings.touchscreen || isSelected)
        {
            ...
            if (this.owner.func_175392_a(slotIndex))
            {
                if (k1 < 16 && l1 < 16)
                {
            ...
            if (this.owner.func_175394_b(slotIndex))
            {
                if (k1 < 16 && l1 > 16)
                {
    ...
    public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_)
    {
        if (p_148278_5_ <= 32)
        {
            ...
            if (p_148278_5_ < 16 && p_148278_6_ < 16 && this.owner.func_175392_a(slotIndex))
            {
                this.owner.func_175391_a(slotIndex, GuiScreen.isShiftKeyDown());
                return true;
            }

            if (p_148278_5_ < 16 && p_148278_6_ > 16 && this.owner.func_175394_b(slotIndex))
            {
                this.owner.func_175393_b(slotIndex, GuiScreen.isShiftKeyDown());
                return true;
            }
        }
