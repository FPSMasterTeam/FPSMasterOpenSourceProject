...
public class GuiNewChat extends Gui {
    ...
    public void drawChat(int updateCounter) {
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN && !ClientSettings.hideChat.getValue()) {
            ...
            if (k > 0) {
                ...
                int j222 = -iii * 9;
                if (iii > 0) {
                    if (ClientSettings.chatBar.getValue()) {
                        drawRect(0, j222 - 1, l + 4, j222, ClientSettings.chatBarColor.getColor());
                    }
                }
                for (int i1 = 0; i1 + this.scrollPos < this.drawnChatLines.size() && i1 < i; ++i1) {
                    ChatLine chatline = this.drawnChatLines.get(i1 + this.scrollPos);
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                ...
                                if (ClientSettings.chatBackground.getValue()) {
                                    drawRect(i2, j2 - 9, i2 + l + 4, j2, ClientSettings.chatBackgroundColor.getColor());
                                }
                                ...
                                if (!getChatOpen()) {
                                    ...
                                    if (l1 == 255) {
                                        chatline.x = chatline.animationUtils.animate(illl, chatline.x, 0.1f, false);
                                        chatline.y = chatline.animationUtils2.animate(j2 - 8, chatline.y, 0.2f, false);
                                    } else {
                                        chatline.x = chatline.animationUtils.animate(0, chatline.x, 0.1f, false);
                                        chatline.y = (float) chatline.animationUtils2.animate(j2, chatline.y, 0.1, false);
                                    }
                                    this.mc.fontRendererObj.drawStringWithShadow(s, -illl + chatline.x, chatline.y, new Color(255, 255, 255, 255).getRGB());
                                } else {
    ...
    public void printChatMessageWithOptionalDeletion(IChatComponent chatComponent, int chatLineId) {
        EventChat eventChat = new EventChat(chatComponent.getFormattedText(), EventChat.Type.RECEIVE);
