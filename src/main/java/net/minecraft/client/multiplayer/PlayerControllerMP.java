...
import top.fpsmaster.modules.render.MoreParticles;
...
public class PlayerControllerMP {
    ...
    public void attackEntity(EntityPlayer playerIn, Entity targetEntity) {
        if (playerIn == mc.thePlayer) {
            mc.thePlayer.attackedOther = true;
            mc.thePlayer.lastAttackTick = 10;
        }

        if (((MoreParticles) FPSMaster.INSTANCE.moduleManager.modules.get("MoreParticles")).sound.getValue()) {
            mc.thePlayer.playSound("dig.stone", 1f, 1);
        }
