...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        this.netManager.sendPacket(new C17PacketCustomPayload("REGISTER", (new PacketBuffer(Unpooled.buffer())).writeString("FPSMaser-Client:" + this.gameController.thePlayer.getName())));
    }
    ...
    public void handleTitle(S45PacketTitle packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        if (this.gameController.ingameGUI.displayingCheating) {
            return;
        }
        String s = null;
        String s1 = null;
        ...
        if (Objects.equals(s, "\2476\247lVICTORY!\247r") ||
                Objects.equals(s, "\2476\247lYOU WIN!\247r") ||
                Objects.equals(s, "\2476\247l胜利！\247r") ||
                Objects.equals(s, "\2476\247l勝利！\247r") ||
                Objects.equals(s, "\247c\247lDEFEAT!\247r") ||
                Objects.equals(s, "\247c\247l遊戲結束！\247r") ||
                Objects.equals(s, "\247c\247l游戏结束！\247r") ||
                Objects.equals(s, "\247c\247lGAME END\247r") ||
                Objects.equals(s, "\247c\247lGAME OVER!\247r") ||
                Objects.equals(s, "\247c\247lFIN DE LA PARTIE\247r") ||
                Objects.equals(s, "\247c\247lSPIELENDE\247r")) {
            ((AutoGG) FPSMaster.INSTANCE.moduleManager.modules.get("AutoGG")).sendGG();
        }
        if (s1 != null) {
            s1 = s1.replace("You can no longer respawn!", "You can no longer die!");
        }
    ...
    private boolean validateResourcePackUrl(NetHandlerPlayClient client, String url, String hash) {
        try {
            URI uri = new URI(url);
            ...
            if (isLevelProtocol && (url.contains("..") || !url.endsWith("/resources.zip"))) {
                ...
                if (player != null) {
                    player.addChatMessage(new ChatComponentText("\247b[FPSMaster] \2474\247l" + I18NUtils.getString("security.resource")));
                }

                throw new URISyntaxException(url, "Invalid level storage resourcepack path");
            }
    ...
    public void handleResourcePack(S48PacketResourcePackSend packetIn) {
        ...
        if (this.validateResourcePackUrl(this, s, s1)) {
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        System.out.println(packetIn.getChannelName());
        byte[] bytes = new byte[packetIn.getBufferData().copy().readableBytes()];
        packetIn.getBufferData().copy().readBytes(bytes);
