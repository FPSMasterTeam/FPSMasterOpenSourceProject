...
import top.fpsmaster.modules.render.SnapLook;
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            if (pointedEntity != null) {
                assert vec33 != null;
                double range = vec3.distanceTo(vec33);
                if (flag && range > this.getRange()) {
                    pointedEntity = null;
...
//                GlStateManager.rotate(entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTicks, -1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(
                        SnapLook.getCameraPrevYaw()
                                + (SnapLook.getCameraYaw() - SnapLook.getCameraPrevYaw()) * partialTicks + 180.0F,
                        0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(
                        SnapLook.getCameraPrevPitch()
                                + (SnapLook.getCameraPitch() - SnapLook.getCameraPrevPitch()) * partialTicks,
                        -1.0F, 0.0F, 0.0F);
            }
...
//                float f2 = entity.rotationPitch;
                float f1 = SnapLook.getCameraYaw();
                float f2 = SnapLook.getCameraPitch();
                ...
                GlStateManager.rotate(SnapLook.getCameraPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(SnapLook.getCameraYaw() - f1, 0.0F, 1.0F, 0.0F);
//                GlStateManager.rotate(entity.rotationPitch - f2, 1.0F, 0.0F, 0.0F);
//                GlStateManager.rotate(entity.rotationYaw - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float) (-d3));
//                GlStateManager.rotate(f1 - entity.rotationYaw, 0.0F, 1.0F, 0.0F);
//                GlStateManager.rotate(f2 - entity.rotationPitch, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(f1 - SnapLook.getCameraYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - SnapLook.getCameraPitch(), 1.0F, 0.0F, 0.0F);
            }
        } else {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists()) {
            if (!this.mc.gameSettings.debugCamEnable) {
                float f6 = SnapLook.getCameraPrevYaw()
                        + (SnapLook.getCameraYaw() - SnapLook.getCameraPrevYaw()) * partialTicks + 180.0F;
                float f7 = SnapLook.getCameraPrevPitch()
                        + (SnapLook.getCameraPitch() - SnapLook.getCameraPrevPitch()) * partialTicks;
...
//                GlStateManager.rotate(entity.prevRotationYaw + (entity.rotationYaw - entity.prevRotationYaw) * partialTicks + 180.0F, 0.0F, 1.0F, 0.0F);
    ...
    public void setupCameraTransform(float partialTicks, int pass) {
        ...
        if (this.mc.gameSettings.viewBobbing && !FPSMaster.INSTANCE.moduleManager.modules.get("MinimizedBobbing").stage) {
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime) {
        ...
        if (flag && SnapLook.overrideMouse()) {
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        GlStateManager.alphaFunc(516, 0.1F);
        EventManager.call(new EventRender3D(EventType.PRE, partialTicks));
        ...
        if (!this.debugView) {
            ...
            if (this.mc.objectMouseOver != null && entity.isInsideOfMaterial(Material.water) && flag1 && !FPSMaster.INSTANCE.moduleManager.modules.get("BlockOverlay").stage) {
        ...
        if (flag1 && this.mc.objectMouseOver != null && !entity.isInsideOfMaterial(Material.water)) {
            ...
            GlStateManager.disableAlpha();
            this.mc.mcProfiler.endStartSection("outline");
            if (!FPSMaster.INSTANCE.moduleManager.modules.get("BlockOverlay").stage) {
        ...
        EventManager.call(new EventRender3D(EventType.POST, partialTicks));
    ...
    public void setupFog(int startCoords, float partialTicks) {
        if (BetterFpsConfig.getConfig().fog && startCoords != -1) return;
