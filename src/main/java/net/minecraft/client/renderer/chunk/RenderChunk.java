...
import top.fpsmaster.utils.chunkAnimationHandler.AsmHandler;
...
public class RenderChunk
{
    ...
    {
        if (ClientSettings.chunkAnimation.getValue()) AsmHandler.setOrigin(this, pos.getX(), pos.getY(), pos.getZ());
