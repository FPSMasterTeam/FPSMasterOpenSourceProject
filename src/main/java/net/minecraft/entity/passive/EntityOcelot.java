...
public class EntityOcelot extends EntityTameable
{
    ...
    {
        if (this.worldObj.checkNoEntityCollision(this.getEntityBoundingBox(), this) && this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox()).isEmpty() && this.worldObj.isNotAnyLiquid(this.getEntityBoundingBox()))
        {
