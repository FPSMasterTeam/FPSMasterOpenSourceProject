...
public class Config
{
    ...
    public static final String OF_RELEASE = "M6_pre1";
    ...
    {
        return "OptiFine_1.8.9_HD_U_M6_pre1";
    }
    ...
    public static String getVersionDebug()
    {
        ...
        stringbuffer.append("OptiFine_1.8.9_HD_U_M6_pre1");
    ...
    public static IResourcePack[] getResourcePacks()
    {
        ...
        for (Object e: list)
        {
            ResourcePackRepository.Entry resourcepackrepository$entry = (ResourcePackRepository.Entry) e;
