...
public class GradientUtil extends Utils {
    ...
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("client/shaders/gradientMask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("client/shaders/gradient.frag");
