...
public class DragonWings extends Module {
    ...
    public ColorValue color = new ColorValue("Color", new Color(0, 0, 0));
    private RenderWings renderWings;

    public DragonWings(String name, String desc) {
        super(name, desc, ModuleCategory.Renders);
        this.addValues(scale, color, colored, chroma);
    }
    ...
    public float[] getColors() {
        ...
        Color color1 = chroma.getValue() ? Color.getHSBColor((System.currentTimeMillis() % 1000) / 1000F, 0.8F, 1F) : ColorUtils.intToColor(color.getColor());
    ...
    public static class RenderWings extends ModelBase {
        ...
        public RenderWings() {
            ...
            this.wingsModule = FPSMaster.INSTANCE.moduleManager.modules.get("DragonWings");
