...
public class RoundPassWordInputBox extends Gui {
    ...
    public RoundPassWordInputBox(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                if (isFocused()) {
                    RenderUtil.drawImage(new ResourceLocation("client/guis/login/input.png"), this.xPosition, this.yPosition, width, height);
                } else {
                    RenderUtil.drawImage(new ResourceLocation("client/guis/login/input.png"), this.xPosition, this.yPosition, width, height, new Color(0, 0, 0, 200));
                }
...
//                drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, -16777216);
            ...
            if (s.length() > 0) {
                ...
                j1 = this.fontRendererInstance.drawString(sb.toString(), (float) l, i1, i);
            }
...
//                k1 = j > 0 ? l + this.width : l;
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                ...
                for (char c : s.substring(j).toCharArray()) {
                    sb2.append("*");
                }
                j1 = this.fontRendererInstance.drawStringWithShadow(sb2.toString(), (float) l + j1 + 2, (float) i1, i);
            }
