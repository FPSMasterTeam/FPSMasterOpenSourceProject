...
public class RoundInputBox extends Gui {
    ...
    private int disabledColor = new Color(50, 50, 50).getRGB();
    ...
    public RoundInputBox(int componentId, UFontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, boolean isPassWord) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                if (isFocused()) {
                    RenderUtil.drawRoundedRect2(this.xPosition, this.yPosition, this.xPosition + width, this.yPosition + height, new Color(200, 200, 200).getRGB());
                } else {
                    RenderUtil.drawRoundedRect2(this.xPosition, this.yPosition, this.xPosition + width, this.yPosition + height, new Color(220, 220, 220).getRGB());
                }
...
//                drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, -16777216);
            ...
            int l = this.enableBackgroundDrawing ? this.xPosition + 10 : this.xPosition;
            ...
            if (pass) {
                if (s.length() > 0) {
                    ...
                    j1 = this.fontRendererInstance.drawString(sb.toString(), (float) l, (float) i1, i);
                }
            } else {
                if (s.length() > 0) {
                    String s1 = flag ? s.substring(0, j) : s;
            ...
            int k1 = xPosition + 10 + j1;

            if (!flag) {
//                k1 = j > 0 ? l + this.width : l;
                k1 = (int) ((float) xPosition + 12 + fontRendererInstance.getStringWidth(s));
            } else if (flag2) {
                k1 = xPosition + 10 + j1 - 1;
                --j1;
            }
            ...
            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, enabledColor);
                } else {
                    if (pass) {

                        this.fontRendererInstance.drawStringWithShadow("_", (float) xPosition + 10 + fontRendererInstance.getStringWidth(sb.toString()), (float) i1, i);
                    } else {
                        this.fontRendererInstance.drawStringWithShadow("_", (float) xPosition + 10 + fontRendererInstance.getStringWidth(s), (float) i1, i);
